...
<body>
   ...
   <div class="text-center">
      <img src="{{ public_path('assets/images/SMK.png') }}" class="img" alt="logo.png" width="90">
      <div style="margin-left:6rem;">
         <span class="text-header text-bold text-danger">
            
               <span class="size2"></span> <br> 
               SEKOLAH MENENGAH KEJURUAN SWASTA TERPADU IBADURRAHMAN <br>
         </span>
         <span class="text-desc"> Jalan Pelabuhan II KM.7/JL KH Acun Mansur <span class="underline">www.smkterpaduibadurrahman</span> - Email <span class="underline">smkti08@gmail.com</span> <br> Desa Tegalega Kec. Lembursitu Kota Sukabumi 43169 <br> </span>
      </div>    
      </div>
   <div>
   <!-- /header -->
